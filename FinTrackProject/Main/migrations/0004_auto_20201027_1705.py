...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='balance_due',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=10, null=True),
        ),
        migrations.AddField(
            model_name='creditcard',
        ...
        migrations.AlterField(
            model_name='spendcategory',
            name='profile',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='spending_categories', to='Accounts.profile'),
        ),
    ]
